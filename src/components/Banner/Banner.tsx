      ...
      <div className='container  mx-auto'>
        ...
        <div className='m-10'>
          ...
          <div className='flex justify-between h-[300px] ml-10 p-2'>
            <div>
              <h2 className="text-3xl md:text-5.5xl text-center md:text-left leading-relaxed font-extrabold text-balance font-sans text-white m-4">Get your Six-Figure <br /> job back in <br /><span className="relative text-yellow-500">8-16 Weeks<svg className="absolute left-0 w-full -bottom-3" height="20" viewBox="0 0 100 10" preserveAspectRatio="none"><path d="M0 5 Q50 0, 100 5" fill="none" stroke="currentColor" strokeWidth="2" className="text-warn"></path></svg></span> <br />with our proven <br /> techniques.</h2>
              <p className=' m-2 text-white font-sans'>Get access actively hiring 20+ premium recruiters today surrounding your location.</p>
            </div>
            <div className='mb-4'>
          ...
          <div className='flex ml-10'>
            <div>
              <Button className='btn bg-[#EAC807] hover:bg-[#F5DE4D] rounded-full text-gray-600 m-4'>Book Free Consultation
