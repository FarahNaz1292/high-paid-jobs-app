...
const Banner = () => {
  return (
    <div className=" relative bg-primary p-10">
      ...
      <div className='container  mx-auto'>
        ...
        <div >
          ...
          <div className='flex  ml-15 mt-10 gap-3'>
            <div>
              <Button className='btn bg-[#EAC807] hover:bg-[#F5DE4D] rounded-full text-gray-600 m-2'>Book Free Consultation
