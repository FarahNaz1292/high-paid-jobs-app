...
const CardsSection = () => {
    return (
        <>
            <div className=" container bg-foreground grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-6 mb-4 md:mb-10 p-6 mx-2 md:mx-auto">
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap text-center text-gray">Land a $100k+ job in 8-16 weeks—or we <br /> keep working until you do</p>
                    </CardHeader>
                ...
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap  text-center text-gray ">Future-ready roles that thrive no matter <br />the economy.</p>
                    </CardHeader>
                ...
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap  text-center text-gray ">Our experts join your interviews to help<br /> you shine</p>
                    </CardHeader>
                ...
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap  text-center text-gray ">Personalized guidance tailored to your <br />goals</p>
                    </CardHeader>
                ...
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap  text-center text-gray ">Secure an extra $5k-$10k on your offer<br /> —guaranteed.
                ...
                <Card className="mx-w-[377px] bg-card-foreground">
                    <CardHeader>
                        ...
                        <p className="text-nowrap  text-center text-gray ">
